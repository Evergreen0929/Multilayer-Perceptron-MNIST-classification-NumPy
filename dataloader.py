...
class MNIST(object):
    ...
    def __split(self):
        self.train_x_set = self.train_x_set[1000:]
        self.train_y_set = self.train_y_set[1000:]
        self.val_x_set = self.train_x_set[:1000]
        self.val_y_set = self.train_y_set[:1000]
        print("Train set size: {}".format(self.train_x_set.shape[0]))
        print("Val set size: {}".format(self.val_x_set.shape[0]))
        print("Test set size: {}".format(self.test_x_set.shape[0]))
